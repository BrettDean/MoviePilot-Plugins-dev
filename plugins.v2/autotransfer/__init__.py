                                ...
                                "content": [
                                    {
                                        ...
                                        "props": {
                                            "type": "info",
                                            "variant": "text",
                                            "text": "两个开关二选一即可。比如原版刷新媒体库的是入库了 '/Library/电视剧/欧美剧/黑镜 (2011)' 以后就让 plex 扫描 '/Library/电视剧/欧美剧/'，而修改版是让 plex 扫描 '/Library/电视剧/欧美剧/黑镜 (2011)/'，从扫描欧美剧下的所有文件夹变为只扫描黑镜，大幅减少工作量。如果媒体服务器不是plex，不管选哪个都是走原来的逻辑",
                                            "density": "compact",
